...
contract('Order Matching', function(accounts) {
    it("test of the Order Matching contract: partial matching 2", function() {
        return OM.deployed().then(function(instance) {
            ...
            return OMInstance.addOrder(80,100,false,"ETH",{from: accounts[0]});             
        }).then(function(result) {
            ...
            return OMInstance.getOrderAmount(0, {from: accounts[0]});             
        }).then(function(result) {
            secondAmount = result;            
            ...
            assert.equal(secondAmount.toNumber(), 20, "new buy order");           
